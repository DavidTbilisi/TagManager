...
def _try_rich_live(
    ...
    def build_display():
        ...
        title = (
            f"[bold cyan]FileTagger Watch[/bold cyan]  "
            ...
            runtime.emit_json(
                {
                    ...
                    "message": "Install watchdog: pip install watchdog or pip install filetagger-cli[watch]",
                }
            )
        else:
            typer.echo(
                ...
                "  or: pip install filetagger-cli[watch]",
                err=True,
            )
        raise typer.Exit(1)
