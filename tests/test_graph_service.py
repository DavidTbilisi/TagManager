#!/usr/bin/env python3
"""Tests for filetagger.app.graph — service, export, and html_generator"""
...
def _patch_tags(tags=None):
    if tags is None:
        tags = SAMPLE_TAGS
    return patch("filetagger.app.helpers.get_tag_file_path", return_value=None), \
           patch("filetagger.app.helpers.load_tags", return_value=dict(tags))
...
class TestBuildTagGraph(unittest.TestCase):
    def setUp(self):
        ...
        self.patcher = patch("filetagger.app.helpers.get_tag_file_path", return_value=self.test_tag_file)
        self.patcher.start()
    ...
    def test_returns_dict_with_required_keys(self):
        from filetagger.app.graph.service import build_tag_graph
    ...
    def test_empty_data(self):
        from filetagger.app.graph.service import build_tag_graph
        with patch("filetagger.app.graph.service.load_tags", return_value={}):
            result = build_tag_graph()
...
class TestBuildFileGraph(unittest.TestCase):
    ...
    def test_returns_correct_mode(self):
        from filetagger.app.graph.service import build_file_graph
...
class TestBuildMixedGraph(unittest.TestCase):
    ...
    def test_returns_correct_mode(self):
        from filetagger.app.graph.service import build_mixed_graph
...
class TestHexToRgb(unittest.TestCase):
    def test_non_six_hex_returns_gray(self):
        from filetagger.app.graph.export import _hex_to_rgb
...
class TestExportGEXF(unittest.TestCase):
    ...
    def test_valid_xml(self):
        from filetagger.app.graph.export import to_gexf
...
class TestExportGraphML(unittest.TestCase):
    ...
    def test_valid_xml(self):
        from filetagger.app.graph.export import to_graphml
    ...
    def test_save_export(self):
        from filetagger.app.graph.export import to_graphml, save_export
...
class TestGenerateHTML(unittest.TestCase):
    ...
    def _get_html(self, **kwargs):
        from filetagger.app.graph.service import build_tag_graph
        from filetagger.app.graph.html_generator import generate_html
