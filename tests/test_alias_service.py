...
class TestAliasService(unittest.TestCase):
    ...
    def setUp(self):
        self.patcher = patch("filetagger.app.alias.service.get_config_manager")
    ...
    def test_get_aliases_empty(self):
        from filetagger.app.alias.service import get_aliases
        self._aliases = {}
    ...
    def test_add_alias_basic(self):
        from filetagger.app.alias.service import add_alias
    ...
    def test_remove_alias_existing(self):
        from filetagger.app.alias.service import remove_alias
    ...
    def test_clear_aliases_returns_count(self):
        from filetagger.app.alias.service import clear_aliases
        self._aliases = {"py": "python", "js": "javascript"}
        count = clear_aliases()
