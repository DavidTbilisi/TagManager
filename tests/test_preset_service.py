...
class TestPresetService(unittest.TestCase):
    ...
    def setUp(self):
        self.patcher = patch("filetagger.app.preset.service.get_config_manager")
    ...
    def test_get_presets_empty(self):
        from filetagger.app.preset.service import get_presets
    ...
    def test_list_presets_alias(self):
        from filetagger.app.preset.service import list_presets
        self._presets = {"a": ["x"]}
    ...
    def test_save_preset_basic(self):
        from filetagger.app.preset.service import save_preset
    ...
    def test_get_preset_existing(self):
        from filetagger.app.preset.service import get_preset
        self._presets = {"work": ["python", "backend"]}
    ...
    def test_delete_preset_existing(self):
        from filetagger.app.preset.service import delete_preset
        self._presets = {"work": ["python"]}
