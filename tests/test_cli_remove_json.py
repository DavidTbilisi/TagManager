...
class TestCliRemoveJson(unittest.TestCase):
    def test_remove_path_json(self):
        ...
        fake = {
            ...
            "path": "/x/y.txt",
            "removed_tags": ["a"],
            "message": "Removed /x/y.txt from FileTagger",
        }
        with patch("filetagger.cli.remove_path", return_value=fake):
    ...
    def test_remove_invalid_json(self):
        ...
        fake = {
            "success": True,
            "message": "Removed 2 invalid path(s) from FileTagger",
            "removed_paths": ["/a", "/b"],
            "count": 2,
        }
        with patch("filetagger.cli.remove_invalid_paths", return_value=fake):
