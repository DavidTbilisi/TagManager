...
class TestAddHandler(unittest.TestCase):
    ...
    @patch('filetagger.app.add.service.add_tags')
...
class TestRemoveHandler(unittest.TestCase):
    ...
    @patch('filetagger.app.remove.handler.remove_path')
    @patch('filetagger.app.remove.handler.remove_invalid_paths')
...
class TestSearchHandler(unittest.TestCase):
    ...
    @patch('builtins.print')
    @patch('filetagger.app.search.handler.search_files_by_tags')
...
class TestTagsHandler(unittest.TestCase):
    ...
    @patch('builtins.print')
    @patch('filetagger.app.tags.service.list_all_tags')
    ...
    @patch('builtins.print')
    @patch('filetagger.app.tags.handler.search_files_by_tag')
