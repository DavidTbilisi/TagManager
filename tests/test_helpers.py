#!/usr/bin/env python3
"""
Comprehensive tests for filetagger.app.helpers
"""
...
class TestHelpers(unittest.TestCase):
    ...
    def _patch_path(self, path=None):
        ...
        return patch('filetagger.app.helpers.get_tag_file_path', return_value=target)
    ...
    def test_levenshtein_swaps_when_s1_shorter(self):
        from filetagger.app.helpers import levenshtein_distance
